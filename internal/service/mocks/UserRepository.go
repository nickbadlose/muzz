...
func (_m *UserRepository) UpdateUserLocation(ctx context.Context, id int, location orb.Point) error {
...
// UserRepository_UpdateUserLocation_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateUserLocation'
type UserRepository_UpdateUserLocation_Call struct {
	*mock.Call
}
...
//   - id int
//   - location orb.Point
func (_e *UserRepository_Expecter) UpdateUserLocation(ctx interface{}, id interface{}, location interface{}) *UserRepository_UpdateUserLocation_Call {
	return &UserRepository_UpdateUserLocation_Call{Call: _e.mock.On("UpdateUserLocation", ctx, id, location)}
}

func (_c *UserRepository_UpdateUserLocation_Call) Run(run func(ctx context.Context, id int, location orb.Point)) *UserRepository_UpdateUserLocation_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *UserRepository_UpdateUserLocation_Call) Return(_a0 error) *UserRepository_UpdateUserLocation_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *UserRepository_UpdateUserLocation_Call) RunAndReturn(run func(context.Context, int, orb.Point) error) *UserRepository_UpdateUserLocation_Call {
	_c.Call.Return(run)
	return _c
}
